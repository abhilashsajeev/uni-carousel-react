...
var Carousel = _React2['default'].createClass({
  ...
  nextSlide: function nextSlide(velocity,distance) {
    ...
    //   sum = this.props.children.length - this.props.slidesToShow;
    // }else if(dist>150 && dist < 380){
    //   sum = (sum + 1)<=(this.props.children.length - this.props.slidesToShow)?sum+1:sum;
    // }
    this.setState({
      currentSlide: sum
    }, function () {
  ...
  previousSlide: function previousSlide(velocity,distance) {
    ...
    console.log(this.state.currentSlide,this.props.slidesToScroll);    
