...
const Carousel = React.createClass({
    ...
    render() {
        ...
        return ( < div className = {
                ['slider', this.props.className || ''].join(' ')
            }
            ref = "slider"
            style = {
                assign(this.getSliderStyles(), this.props.style || {})
            } >
                ...
                this.props.decorators ?
                    this.props.decorators.map(function(Decorator, index) {
                        return ( < div style = {
                            ...
                            className = {
                                'slider-decorator-' + index
                            }
                            key = {
                                index
                            } >
                            < Decorator.component currentSlide = {
                                self.state.currentSlide
                            }
                            slideCount = {
                                self.state.slideCount
                            }
                            slidesToShow = {
                                self.props.slidesToShow
                            }
                            slidesToScroll = {
    ...
    formatChildren(children) {
        ...
        return children.map(function(child, index) {
            return <li className = "slider-slide"
            style = {
                self.getSlideStyles()
            }
            key = {
    ...
    setInitialDimensions() {
        var self = this,
            slideWidth, frameWidth, frameHeight, slideHeight;
    ...
    setDimensions() {
        var self = this,
            slideWidth, firstSlide, frame, frameHeight, slideHeight;
